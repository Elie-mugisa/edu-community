...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col  items-center bg-white dark:bg-sky-950 ">
      {/* //? header */}
      <Header_ />

      {/* action */}
      <div className="flex min-h-[90vh]  w-full flex-col justify-end px-4 py-4 gap-4 md:px-10 lg:gap-6 lg:px-[5vw] lg:flex-row lg:items-end ">
        {/* // ? TEXT BOX */}
        <div className="w-full flex flex-col gap-8 items-center h-full  lg:items-start lg:pb-[10vh] lg:justify-end lg:w-[50%] lg:gap-12 ">
          <div className="w-[80vw] flex flex-col items-center gap-4  md:w-[60vw] lg:w-[30vw] lg:items-start">
            <h2 className="text-2xl font-bold text-[#111] lg:text-3xl ">
              {t("2")}
            </h2>
            <MyDivider className="bg-gradient-to-r from-[#3832F2]  to-[#c648f8] w-[20vw] h-[1px] lg:w-[10vw] " />
            <h1 className="text-3xl font-bold text-transparent  bg-clip-text bg-gradient-to-r from-[#3832F2] via-[#7BC8FF] to-[#7BC8FF] lg:text-5xl lg:leading-14">
              {w("title")}
            </h1>
          </div>
          <div className="flex items-center gap-4 lg:w-[40vw] ">
            <RiLightbulbFlashFill className="text-2xl lg:text-4xl text-[#ffbc2b] " />
            <MyDivider className="h-10" />
            <p className="text-[#999] text-xl ">{w("desc")}</p>
          </div>

          {/* //? BTN */}
          <Link
            href={"/signIn"}
            className="px-5 py-1.5 flex items-center gap-4 bg-gradient-to-r  from-[#3832F2]  to-[#c648f8] transition-all duration-300 text-white  hover:opacity-80 rounded-full md:px-8 lg:py-2 lg:mt-[8vh] "
          >
            {w("getStarted")}
...
function Header_() {
  ...
  return (
    <div className=" w-full flex gap-4 justify-between  items-center py-4 px-4 lg:px-[5vw]">
